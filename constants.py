...
# 1st Group in identifying the element name.
...
at_charges = ["Positive Charge", "Negative Charge"] # is this needed
...
# Detailed breakdowns on 2nd Group
grp2_sym = ["Metals",  "Non_Metals", "Metalloids"]
grp2_name = ["n_Metals", "n_NonMetals", "n_Metalloids"]
grp2 = [grp2_sym, grp2_name] # is this needed

# Atomic Elements
atomic_element = ["grp1", "grp2", "Atomic_Number", "Atomic_Charge"]

# Gas Laws
gas_laws = {"Boyle", "Charles", "Gay_Lussac", "Avogadro", "Ideal_Gas", "Combined_Gas", "Celsius_fahrenheit", "Fahrenheit_celsius"}
boyle = {"@P1", "@V1", "@P2", "@V2"}
charles = {"@T1", "@T2"}
gay_lussac = {"Charles", "Boyle"}
avogadro = {"@N1", "@N2"}
ideal_gas = {"@p", "@V", "@n", "@R", "@T" }
